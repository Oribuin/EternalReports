...
class SQLiteConnector(private val plugin: Plugin) : DatabaseConnector {
    private val connectionString: String = "jdbc:sqlite:${plugin.dataFolder}${File.separator}eternalreports.db"
